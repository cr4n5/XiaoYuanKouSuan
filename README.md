...
- 方案三： 修改 pk 场 js 文件（仅限 pk 场）在此特别感谢 [Ulua3809](https://github.com/ulua3809)! [方案三链接](Re_js/README.md) [废弃方案三中正则修改js，正则表达式按此更新](https://github.com/cr4n5/XiaoYuanKouSuan/issues/113)
